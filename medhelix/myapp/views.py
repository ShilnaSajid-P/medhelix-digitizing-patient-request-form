...
def add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Set the values for the new Userr instance
            video_streaming = Userr()
            video_streaming.serial_no = form.cleaned_data['serial_no']
            video_streaming.date = form.cleaned_data['date']
